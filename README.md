...
| 03     | [kubectl & auth](03-kubectl-auth.md)         | Certs, users, RBAC — how the API answers "can this caller do this?"      |
| 04     | [scheduler](04-scheduler.md)                 | Watch a Pod hang `Pending`, then get bound                               |
